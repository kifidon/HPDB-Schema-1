...
VALUES ('C123', 'client@client.com' , 'Client A', 'Location A');

-- Insert data into representative table
INSERT INTO representative (EMAIL, REP_NAME, PHONE_NUM, cID)
VALUES ('email1@example.com', 'Representative 1', '123-456-7890', 'C123');

-- Example entries for projCode table
INSERT INTO Project (id, [name], code,  client_id) 
VALUES ('1234213sa', 'Project A23', 'A23-000-0000', 'C123');

INSERT INTO Project (id, [name], code,  client_id) 
VALUES ('1234213sb', 'Project A24', 'A24-000-0000', 'C123');
...
INSERT INTO subContractorsLem (WID, PROJ_NUM, LemNumber, REF_NUM, QTY, UNIT_PRICE, [DESCRIPTION])
VALUES ('WID_S001', 'A24-000-0000', 2, 'REF001', 3, 150, 'Subcon Description');

INSERT INTO LemRates (WID, CALENDAR_DAY_START, CALENDAR_DAY_END, REG_RATE)
...
SELECT * FROM EmpLemTable;
SELECT * FROM subContractorsLem;
SELECT * FROM subConLemView;
SELECT * FROM MatLemTable;
